...
<!-- Keeping in mind your comments after our presentation, we have also done a quick logistic regression on the individual quality of white and red wine. Feel free to un comment to check out the results. -->
...
<!-- true_positives_white <- 2266 -->
<!-- true_negatives_white <- 708 -->
<!-- false_positives_white <- 633 -->
<!-- false_negatives_white <- 335 -->
<!-- total <- 3942 -->
...
<!-- ```{r} -->
<!-- true_positives_red <- 525 -->
<!-- true_negatives_red <- 477 -->
<!-- false_positives_red <- 161 -->
<!-- false_negatives_red <- 190 -->
<!-- total <- 1353 -->
